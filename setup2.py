...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "You are the monster"

        #Project url
        self.project_url = "https://github.com/gustavnilsson14/PyBox2dBoiler/"
        ...
        #Auhor of program
        self.author_name = "gustavnilsson14, Krexxor & MarcusDrake"
        self.author_email = "example@example.com"
        self.copyright = ""

        #Description
        self.project_description = "Ludum Dare 2015"

        #Icon file (None will use pygame default icon)
        self.icon_file = None

        #Extra files/dirs copied to game
        self.extra_datas = ['lib', 'res', 'src']
        ...
        self.extra_scripts = ["Box2D", "numpy", "pkg_resources", "pygame"]
